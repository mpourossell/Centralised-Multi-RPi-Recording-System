...
if __name__ == "__main__":
    ...
    # Example usage:
    video_dir = r"E:\videos_ALL"  # Video file path
    detection_csv_dir = r"G:\Mi unidad\Marçal's PhD\001_automated_jackdaw_monitoring\C_processed_data"  # CSV file with detections
    annotation_csv_path = "annotations/annotations.csv"  # Path to save manual annotations
    #
    ...
    #
    # # Remove the video from the list after processing
    # #video_files.remove(video_file)
    #
    # # Compute metrics based on annotations after completing the process
