# This script is used by all units to request sending their status to the Flask api, even the parent.
# It will send information to the Flask api generated by the parent unit, so it can publish it in the web server.
